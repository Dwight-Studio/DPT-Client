...
class ButtonRed(pygame.sprite.Sprite):
    texture = "dpt.images.environment.buttons.Button_Red_Up"
    textures = "dpt.images.environment.buttons.Button_Red_*"
        ...
        if TileEditor.is_editing:
            ...
            if not self.clicked and self.colliding:
                ...
                if self.up:
                    self.up = False
                    self.down = True
                    texture = "dpt.images.environment.buttons.Button_Red_Down"
