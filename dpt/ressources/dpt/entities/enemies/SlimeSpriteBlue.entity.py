...
class SlimeSpriteBlue(pygame.sprite.Sprite):
    """Classe sur les slimes bleus et leur physique"""
    texture = "dpt.images.characters.slimes.Slime_Blue_1"
    dead_texture = "dpt.images.characters.slimes.Dead_Slime_Blue"
    textures = "dpt.images.characters.slimes.Slime_Blue_*"
    ...
    def __init__(self, x, y):
        ...
        self.maskSurface = pygame.transform.scale(RessourceLoader.get(SlimeSpriteBlue.mask),
    ...
    def kill(self):
        ...
        if not TileEditor.is_editing and not TileManager.is_loading_level:
            DeadBody(self.rect.x, self.rect.y, self.rect.width, self.rect.height, SlimeSpriteBlue.dead_texture, SlimeSpriteBlue.mask)
