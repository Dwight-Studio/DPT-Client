...
class SlimeSpriteGreen(pygame.sprite.Sprite):
    """Classe sur les slimes verts et leur physique"""
    texture = "dpt.images.characters.slimes.Slime_Green_1"
    dead_texture = "dpt.images.characters.slimes.Dead_Slime_Green"
    textures = "dpt.images.characters.slimes.Slime_Green_*"
    ...
    def __init__(self, x, y):
        ...
        self.maskSurface = pygame.transform.scale(RessourceLoader.get(SlimeSpriteGreen.mask),
    ...
    def kill(self):
        ...
        if not TileEditor.is_editing and not TileManager.is_loading_level:
            DeadBody(self.rect.x, self.rect.y, self.rect.width, self.rect.height, SlimeSpriteGreen.dead_texture, SlimeSpriteGreen.mask)
