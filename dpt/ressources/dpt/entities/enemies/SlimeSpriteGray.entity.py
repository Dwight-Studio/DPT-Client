...
class SlimeSpriteGray(pygame.sprite.Sprite):
    """Classe sur les slimes gris et leur physique"""
    texture = "dpt.images.characters.slimes.Slime_Gray_1"
    dead_texture = "dpt.images.characters.slimes.Dead_Slime_Gray"
    textures = "dpt.images.characters.slimes.Slime_Gray_*"
    ...
    def __init__(self, x, y):
        ...
        self.maskSurface = pygame.transform.scale(RessourceLoader.get(SlimeSpriteGray.mask),
    ...
    def kill(self):
        ...
        if not TileEditor.is_editing and not TileManager.is_loading_level:
            DeadBody(self.rect.x, self.rect.y, self.rect.width, self.rect.height, SlimeSpriteGray.dead_texture, SlimeSpriteGray.mask)
