...
class WormLavaSprite(pygame.sprite.Sprite):
    """Classe sur les vers de lave et leur physique"""
    texture = "dpt.images.characters.animals.Worm_Lava_1"
    dead_texture = "dpt.images.characters.animals.Dead_Worm_Lava"
    textures = "dpt.images.characters.animals.Worm_Lava_*"
    ...
    def __init__(self, x, y):
        ...
        self.maskSurface = pygame.transform.scale(RessourceLoader.get(WormLavaSprite.mask),
    ...
    def kill(self):
        ...
        if not TileEditor.is_editing and not TileManager.is_loading_level:
            DeadBody(self.rect.x, self.rect.y, self.rect.width, self.rect.height, WormLavaSprite.dead_texture, WormLavaSprite.mask)
