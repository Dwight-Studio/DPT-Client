...
class GhostSpriteDark(pygame.sprite.Sprite):
    """Classe sur les fantômes sombres et leur physique"""
    ...
    def __init__(self, x, y):
        ...
        self.big = False
        self.distance = 0
        self.mask = pygame.mask.from_surface(pygame.transform.scale(RessourceLoader.get(GhostSpriteDark.mask),
