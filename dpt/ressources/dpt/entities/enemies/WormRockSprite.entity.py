...
class WormRockSprite(pygame.sprite.Sprite):
    """Classe sur les vers de pierre et leur physique"""
    ...
    def __init__(self, x, y):
        ...
        self.maskSurface = pygame.transform.scale(RessourceLoader.get(WormRockSprite.mask),
    ...
    def kill(self):
        ...
        if not TileEditor.is_editing and not TileManager.is_loading_level:
            DeadBody(self.rect.x, self.rect.y, self.rect.width, self.rect.height, WormRockSprite.dead_texture, WormRockSprite.mask)
